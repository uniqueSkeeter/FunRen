			...
			var cardMaintainBean = $('#card_dg').datagrid('getSelected');
			  if (!cardMaintainBean){
				  ...
				  if(cardMaintainBean.cardType=="13"){
					  $.messager.alert("错误",'不记名卡不能挂失!');
					  return ;
				  }
				  if(cardMaintainBean.cardStatus!="1"){
					  $.messager.alert("错误",'该卡不在启用状态下不能挂失!');
					  return ;
				  }
