...
var cardTradeListColumns = [[ 
            			{field:'tradeDate',title:'交易日期',width:100,align:'left'},
            			{field:'incNo',title:'交易号',width:100,align:'left'},
            			{field:'guestName',title:'持卡人',width:60,align:'left'},
            			...
            			{field:'receiptType',title:'单据类型',width:60,formatter: function(value,row,index){
							var key = "option[value='" + value + "']";
							var text = $("#receiptType").find(key).text();
							return text;
            			},align:'left'},
