...
<!-- css -->
<!-- js -->
<script type="text/javascript" src="<%=basePath%>js/card/customer/customCancel/displayDriverDeleteList.js"></script>
<title>司机卡卡注销</title>
</head>
<body>
	<TABLE style="font-size: 9px; font-family: Arial; table-layout: fixed; width: 100%; height: 63%">
		<TR>
			<TD width="86%" valign="top" style="border-left: #7BAED5 solid 0px; padding-left: 2px">
				<span class="pageFontStyle">司机卡注销</span>
				<hr class="lineColor">
				...
				<table class="tableButton">
					<tr>
						<td>
							<input type=button id="haveCardDelete" value="有卡注销">
						</td>
						<td>
							<input type=button id="noHaveCardDelete" value="无卡注销">
						</td>
				...
				<br>
				<table id="dg" title="司机卡一览" style="width: auto; height: auto;">
				</table>
			</TD>
		</TR>
	</TABLE>
