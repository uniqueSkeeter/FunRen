...
<script type="text/javascript" src="<%=basePath%>js/card/report/displayCardPredistributionList.js"></script>
</head>
<body>
	<TABLE style="font-size: 9px; font-family: Arial; table-layout: fixed; width: 100%; height: 75%">
		<tr>
			<td width="70%" valign="top" style="border-left: #7BAED5 solid 0px; padding-left: 2px">
				<span class="pageFontStyle">预分配明细</span>
				<hr class="lineColor">
				<table style="font-size: 12px;width: 100%; height: 50px; font-weight: bold;">
					...
					<tr>
						...
						<td height="30px" width="60px"><input type='button' value='&nbsp;查&nbsp;询' id="cardPredistribution_search"></td>
					</tr>
				...
				<hr class="lineColor">
				<table id="cardPredistributionListTable" title="预分配明细表" style="width: 1000px;height: auto;">
				</table>
			</td>
		</tr>
	</TABLE>
