...
<body>
			...
			<td width="86%" valign="top"
				...
				<table style="font-size: 12px;width: 100%; height: 50px; font-weight: bold;" class="tableContent">
					...
					<tr style="display:none">
						...
						<td height="30px" width="100px">
							<select id="stationList" style="width:150px">
								<option selected>   </option>
	...
	<div id="applyCardDialog" class="easyui-window" closed="true" modal="true" title="标题" style="width:700px;height:260px;"> 
    	<iframe  id='applyCardIFrame' frameborder="0"  src="" style="width:100%;height:150px;"></iframe> 
	</div>
	<div id="returnCardDialog" class="easyui-window" closed="true" modal="true" title="标题" style="width:700px;height:260px;"> 
    	<iframe  id='returnCardIFrame' frameborder="0"  src="" style="width:100%;height:150px;"></iframe> 
	</div>
	<div id="editCardDialog" class="easyui-window" closed="true" modal="true" title="标题" style="width:700px;height:450px;"> 
    	<iframe  id='editCardIFrame' frameborder="0"  src="" style="width:100%;height:450px;"></iframe> 
	</div>
</body>
</html>