...
<body onload="show();" style="width:600px">
	...
	<p style="color:#2874ff;font-size: 13px;text-align: right">当前站点:${stationNo} ${stationName} 当前班次 :${classNo}</p>
	...
	<form id= "cardListModify-form" method="post" action="cardStorage/saveCardOrder">
			<table style="font-size: 20px;width:600px; height: 100px">
				...
				<tr>
					...
					<td style="height:5px; width:100px">
						<c:set var="receiverKey" value="${cardStorageBean.receiver}"></c:set>
						<input type="text" name="cardStorageBean.receiverName" id="receiverName" value="${stationList[receiverKey]}"  style="width:150px">
					</td>
					<td style="height:3px; width:80px;">供货方:</td>
					<td height="5px" style="width:100px">
						<c:set var="supplierKey" value="${cardStorageBean.supplier}"></c:set>
						<input type="text" name="cardStorageBean.supplierName" id="supplierName" value="${stationList[supplierKey]}"  style="width:150px">
					</td>
				</tr>
				<tr>
	...
	<table id="tt" style="width:600px;height:auto"
		...
		<thead>
			<tr>
				<th field="startNo" editor="text" width="150">起始号</th>
				<th field="endNo" editor="text" width="150">结束号</th>
				<th field="cardSum" editor="text" width="120">数量</th>
