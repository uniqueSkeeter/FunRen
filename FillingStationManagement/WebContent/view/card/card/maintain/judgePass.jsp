...
<body>
		...
		<table>
	    	...
	    	<tr>
				...
				<td height="30px" style="width:30px">
					<input type="password"name="cardMaintainBean.cardPass"  maxlength="16" style="width:140px" id="oldPassword"></input>
				</td>
				<td>
	...
	<div id="enter_new_password" class="easyui-window" title="第二步：请持卡人输入新密码" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:500px;height:200px;padding:10px;">
    	...
    	<tr>
			...
			<td height="30px" style="width:30px">
				<input type="password" style="width:140px"  maxlength="16" id="newPassword"></input>
			</td>
    	</tr>
    	<p>
    	<tr>
			...
			<td height="30px" style="width:30px">
				<input type="password" style="width:140px"  maxlength="16" id="newPassword2"></td>
    	</tr>
    	<tr>
