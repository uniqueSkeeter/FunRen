...
public class CardStorageDetailServiceImpl extends AbstractBaseService<CardStorageDetailEntity> implements
	...
	private List<CardStorageDetailEntity> initialCardDetailEntity(String cardData) {
		...
		for (String data : dataArray) {
			...
			Integer startNo = Integer.valueOf(storageDetailEntity.getStartNo().substring(11));
			Integer endNo = Integer.valueOf(storageDetailEntity.getEndNo().substring(11));
			storageDetailEntity
					.setCardAcount(Long.valueOf(endNo - startNo) + 1);
