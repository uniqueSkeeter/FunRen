...
<script type="text/javascript" src="<%=basePath%>js/card/report/displayCardTradeList.js"></script>
</head>
<body>
	<TABLE style="font-size: 9px; font-family: Arial; table-layout: fixed; width: 100%; height: 75%">
		<tr>
			<td width="70%" valign="top" style="border-left: #7BAED5 solid 0px; padding-left: 2px">
				<span class="pageFontStyle">卡交易明细</span>
				<hr class="lineColor">
				<table style="font-size: 12px;width: 100%; height: 50px; font-weight: bold;">
					<tr>
						...
						<td height="30px" width="200px" >
							<input type="text" name="cardTradeReportBean.guestName" id="guestName"  style="width:150px" maxLength="10">
						</td>
					...
					<tr>
						...
						<td height="30px" width="60px">卡类型:</td>
						<td height="30px" width="200px" >
							<select name="cardTradeReportBean.cardType" id="cardType" style="width:150px">
					...
					<tr>
						...
						<td height="30px" width="60px"><input type='button' value='&nbsp;查&nbsp;询' id="cardTrade_search"></td>
					</tr>
					...
					<tr style="display:none">
						<td>
							<select  id="receiptType" style="width:150px">
								<option selected>   </option>
								<c:forEach var="receiptType" items="${allocateType}">
				...
				<hr class="lineColor">
				<table id="cardTradeListTable" title="卡交易明细表" style="width: 1000px;height: auto;">
				</table>
			</td>
		</tr>
	</TABLE>
