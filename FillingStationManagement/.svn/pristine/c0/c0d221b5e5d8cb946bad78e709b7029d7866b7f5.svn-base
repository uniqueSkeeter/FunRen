...
<body id="printCardCharge_body">
	...
	<tr>
		...
		<td style="height: 50px; width: 100px; text-align: center;">客户状态</td>
		<td style="height: 50px; width: 100px; text-align: center;">
			<span id="guestStatus"><%= java.net.URLDecoder.decode(request.getParameter("guestStatus"),"utf-8")%></span>
		</td>
	</tr>
	<tr>
		<td style="height: 50px; width: 100px; text-align: center;">充值额</td>
		<td style="height: 50px; width: 100px; text-align: center;">
		...
		<td style="height: 50px; width: 100px; text-align: center;">
			<span id="spareAccount"><%= request.getParameter("spareAccount")%></span>
		</td>
	</tr>
	<tr>
		<td colspan="6">
