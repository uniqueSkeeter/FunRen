...
public class RegisterCustomerBean implements StandardBean {
	 ...
	 * 部门编号到部门名称
	 */
	private final Map<String, String> depNoToName = new HashMap<String, String>();
	 ...
	 * 部门编号到部门名称
	 */
	public Map<String, String> getDepNoToName() {
		return this.depNoToName;
	}
	...
	public String toString() {
		return "RegisterCustomerBean [id=" + this.id + ", guestName=" + this.guestName + ", guestNo=" + this.guestNo
				...
				+ ", mainCardFlag=" + this.mainCardFlag + ", depNoToName=" + this.depNoToName + ", pageNumber="
				+ this.pageNumber + ", pageSize=" + this.pageSize + ", totalData=" + this.totalData + "]";
	}
