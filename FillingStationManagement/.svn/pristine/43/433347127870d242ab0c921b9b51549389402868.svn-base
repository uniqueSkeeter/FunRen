	...
	<tr>
		<td width="86%" valign="top" style="border-left: #7BAED5 solid 0px; padding-left: 2px">
			<table style="font-size: 12px; width: 100%; height: 10px; font-weight: bold;">
				<tr>
					<td height="30px" style="width: 70px">卡号:
					...
					<td height="30px" style="width: 100px">客户编号:</td>
					<td height="30px" width="80px" style="width: 180px">
				...
				<tr>
					...
					<td height="30px" style="width: 100px">有效期:</td>
					<td height="30px" width="80px" style="width: 180px">
				...
				<tr>
					...
					<td>
					    <input height="14" border="0" width="14" type="radio" name="cardMaintainBean.lostChoice" id="lostChoice" value="使用证件" checked="checked">使用证件 </input>
					</td>
					<td>
					    <input height="14" border="0" width="14" type="radio" name="cardMaintainBean.lostChoice"id="lostChoice" value="使用主卡">使用主卡</input>
			        </td>
					<!-- 隐藏-->
					<td>
					    <input name="cardMaintainBean.deposit" value="${cardMaintainBean.deposit}" style="display: none;" id="deposit"></input>
					</td>
				</tr>
			</table>
