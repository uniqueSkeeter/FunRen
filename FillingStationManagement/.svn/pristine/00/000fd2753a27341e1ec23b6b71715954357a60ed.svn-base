...
<script type="text/javascript" src="<%=basePath%>js/card/card/maintain/displayCorpCard.js"></script>
			...
			<table style="font-size: 12px;width: 100%; height: 50px; font-weight: bold;" class="tableContent">
				<tr>
					...
					<td height="30px" width="100px">
						<input type="text" name="updateCardInfoBean.mainCardNo" id="mainCardNo"  maxlength="20" style="width:180px">
					</td>
