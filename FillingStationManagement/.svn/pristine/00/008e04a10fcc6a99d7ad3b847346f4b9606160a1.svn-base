...
public class CardMaintainBean extends CommonBean implements StandardBean {
	...
	/**
	 * 新卡印刷号(cardexno) FK_T_CARD(卡信息表)
	 */
	private String newPrintNumber;
	...
	public String getNewPrintNumber() {
		return this.newPrintNumber;
	}

	public void setNewPrintNumber(String newPrintNumber) {
		this.newPrintNumber = newPrintNumber;
	}

	public boolean isLostTimeFlag() {
		return this.lostTimeFlag;
	}

	public void setLostTimeFlag(boolean lostTimeFlag) {
		this.lostTimeFlag = lostTimeFlag;
	}
	...
	public String toString() {
		return "CardMaintainBean [id=" + this.id + ", guestName=" + this.guestName + ", guestNo=" + this.guestNo + ", cardNo="
				...
				+ this.stationNo + ", printNumber=" + this.printNumber + ", newPrintNumber=" + this.newPrintNumber
				+ ", cardType=" + this.cardType + ", deposit=" + this.deposit + ", cardAmount=" + this.cardAmount
				+ ", cardPass=" + this.cardPass + ", refuelLimit=" + this.refuelLimit + ", refuelTimes=" + this.refuelTimes
				+ ", consumeAmount=" + this.consumeAmount + ", oilTypeLimit=" + this.oilTypeLimit + ", effectiveDate="
				+ this.effectiveDate + ", disEffectiveDate=" + this.disEffectiveDate + ", stationInfoLimit="
				+ this.stationInfoLimit + ", remark=" + this.remark + ", gender=" + this.gender + ", email=" + this.email
				+ ", zipCode=" + this.zipCode + ", customerAddr=" + this.customerAddr + ", carNoConstr=" + this.carNoConstr
				+ ", guestStatus=" + this.guestStatus + ", passFlag=" + this.passFlag + ", newCardNo=" + this.newCardNo
				+ ", newCardType=" + this.newCardType + ", newCardPreAccount=" + this.newCardPreAccount + ", companyName="
				+ this.companyName + ", score=" + this.score + ", dayNumber=" + this.dayNumber + ", provisionAccount="
				+ this.provisionAccount + ", provisionScore=" + this.provisionScore + ", dayTime=" + this.dayTime + ", carNo="
				+ this.carNo + ", note=" + this.note + ", note2=" + this.note2 + ", workDate=" + this.workDate
				+ ", companyNum=" + this.companyNum + ", pageNumber=" + this.pageNumber + ", pageSize=" + this.pageSize
				+ ", totalData=" + this.totalData + ", pre=" + this.pre + ", lostTimeFlag=" + this.lostTimeFlag + "]";
	}
