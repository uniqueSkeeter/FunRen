...
public class StationEntity implements StandardBean {
	...
	public String toString() {
		return "StationEntity [id=" + this.id + ", emplEntity=" + this.emplEntity + ", stationNum=" + this.stationNum + ", name=" + this.name
				+ ", telephone=" + this.telephone + ", fax=" + this.fax + ", zipCode=" + this.zipCode + ", address=" + this.address + ", taxCode="
				+ this.taxCode + ", backNum=" + this.backNum + ", runType=" + this.runType + ", printType=" + this.printType + ", outOrderNum="
				+ this.outOrderNum + ", inOrderNum=" + this.inOrderNum + ", otherOrderNum=" + this.otherOrderNum + ", otherOrderNum2="
				+ this.otherOrderNum2 + ", manger=" + this.manger + ", upCompany=" + this.upCompany + ", createDate=" + this.createDate
