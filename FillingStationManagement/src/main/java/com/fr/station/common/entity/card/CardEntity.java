...
public class CardEntity extends BaseEntity implements Cloneable {
	 ...
	 * 卡类型
	 */
	@Column(name = "`CARDTYPE`", updatable = false)
	 ...
	 * 主卡标志
	 */
	@Column(name = "`cardFlag`", updatable = false)
	 ...
	 * 钱包账户 (账户余额)
	 */
	@Column(name = "`CARDBAL`", updatable = false)
	private BigDecimal cardbal;

	/**
	 * 充值金额
	 */
	@Column(name = "`CARDINC`", updatable = false)
	private BigDecimal cardinc;

	/**
	 * 消费金额
	 */
	@Column(name = "`CARDDEC`", updatable = false)
	private BigDecimal carddec;

	/**
	 * 启用日期
	 */
	@Column(name = "`BEGDATE`", updatable = false)
	 ...
	 * 网点
	 */
	@Column(name = "`STATIONNO`", updatable = false)
	 ...
	 * 限车号标示
	 */
	@Column(name = "`xcarflag`")
	@org.hibernate.annotations.Type(type = "yes_no")
	private Boolean carNoFlag = false;
	 ...
	 * 班结号
	 */
	@Column(name = "`accNo`", updatable = false)
	 ...
	 * 预分配金额
	 */
	@Column(name = "`PRE`", updatable = false)
	...
	public Boolean getCarNoFlag() {
		return this.carNoFlag;
	}

	public void setCarNoFlag(Boolean carNoFlag) {
		this.carNoFlag = carNoFlag;
	}

	public Boolean getStationFlag() {
		return this.stationFlag;
	}

	public void setStationFlag(Boolean stationFlag) {
	...
	public String toString() {
		return "FkTCardEntity [id=" + this.id + ", guestNo=" + this.guestNo + ", cardexno=" + this.cardexno + ", cardno="
				+ this.cardno + ", cardstatus=" + this.cardstatus + ", cardtype=" + this.cardtype + ", guestname="
				+ this.guestname + ", guesttype=" + this.guesttype + ", guestnum=" + this.guestnum + ", guestpost="
				+ this.guestpost + ", cardFlag=" + this.cardFlag + ", guestadd=" + this.guestadd + ", guesttel="
				+ this.guesttel + ", email=" + this.email + ", cardbal=" + this.cardbal + ", cardinc=" + this.cardinc
				+ ", carddec=" + this.carddec + ", begdate=" + this.begdate + ", enddate=" + this.enddate + ", deposit="
				+ this.deposit + ", billType=" + this.billType + ", cylindersNo=" + this.cylindersNo + ", stationno="
				+ this.stationno + ", xoil=" + this.xoil + ", xeareflag=" + ", xeare=" + this.xeare
				+ ", xvol=" + this.xvol + ", xcount=" + this.xcount + ", xamn=" + this.xamn + ", xcarno=" + this.xcarno
				+ ", password=" + this.password + ", accNo=" + this.accNo + ", accDate=" + this.accDate + ", passFlag="
				+ this.passFlag + ", lostflag=" + this.lostflag + ", bz=" + this.bz + ", pre=" + this.pre + ", createDate="
				+ this.createDate + ", updateDate=" + this.updateDate + ", userid=" + this.userid + ", gender=" + this.gender
				+ ", seriaNum=" + this.seriaNum + ", deptNum=" + this.deptNum + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((this.cardFlag == null) ? 0 : this.cardFlag.hashCode());
		...
		result = prime * result + (this.passFlag ? 1231 : 1237);
	...
	public boolean equals(Object obj) {
		...
		if (this.cardFlag == null) {
			if (other.cardFlag != null) {
				return false;
			}
		} else if (!this.cardFlag.equals(other.cardFlag)) {
			return false;
		}
