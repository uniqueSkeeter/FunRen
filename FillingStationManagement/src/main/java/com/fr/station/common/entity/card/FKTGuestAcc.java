...
public class FKTGuestAcc implements StandardBean {
	...
	public String toString() {
		return "FKTGuestAcc [id=" + this.id + ", guestNo=" + this.guestNo + ", cardacc=" + this.cardacc + ", bal=" + this.bal + ", debitacc="
				+ this.debitacc + ", creditacc=" + this.creditacc + ", inuse=" + this.inuse + ", score=" + this.score + ", etc=" + this.etc
