...
public class CustomerChargeDaoImpl extends AbstractBaseDAO<FkTtGuestcreditEntity> implements CustomerChargeDAO {
	 ...
	 * 更新客户账户SQL
	 */
	private final String updateGuestAccSql = "UPDATE FK_T_GUESTACC SET bal = ? ,creditacc = ? ,update_date = ?  WHERE id = ? ";
	...
	/**
	 * @Inherited doc 卡充值时更新卡账信息表
	 */
	@Override
	public void updateGuestAccEntity(FKTGuestAcc guestAccEntity) {
		Object[] args = { guestAccEntity.getBal(), guestAccEntity.getCreditacc(), DateUtil.currentTimestamp(),
				guestAccEntity.getId() };
