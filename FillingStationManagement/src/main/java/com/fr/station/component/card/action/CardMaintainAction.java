...
public class CardMaintainAction extends AbstractAction {
	...
	private List<CardMaintainBean> unLockCardList = new ArrayList<CardMaintainBean>();
	...
	@Action(value = "cardMaintainList", results = {
			@Result(name = "success", location = "/view/card/card/maintain/cardMaintain.jsp"),
	 ...
	 * 
	 */
	@Action(value = "showCardLost", results = { @Result(name = "success", location = "/view/card/card/maintain/cardLost.jsp"),
			@Result(name = "error", location = "/view/login.jsp") })
	...
	@Action(value = "allCardLost", results = { @Result(name = "success", type = "chain", location = "showCardMaintainList"),
			@Result(name = "error", location = "/view/login.jsp") })
	public String allCardLost() {
		log.info("Starting to transfer card lost infomation to service ");
		boolean flag = false;
		try {
			this.cardMaintainService.updateAllCardLost(this.cardMaintainBean);
			flag = true;
		} catch (net.sf.json.JSONException e) {
			log.info("Convert to Json object occured error, please references the detail log\n " + "[" + e + "]\n"
					+ ErrorLogUtil.printInfo(e));
	...
	@Action(value = "showCancelLossCard", results = {
			@Result(name = "success", location = "/view/card/card/maintain/cancelLossCard.jsp"),
			@Result(name = "error", location = "/view/login.jsp") })
	 ...
	 * 
	 */
	@Action(value = "showUnLockCard", results = {
			@Result(name = "success", location = "/view/card/card/maintain/unLockCard.jsp"),
			@Result(name = "error", location = "/view/login.jsp") })
	public String showUnLockCard() {
		log.info("Starting to search for card (unLock Card) data");
		boolean flag = false;
		try {
			this.unLockCardList = this.cardMaintainService.getUnLockCard(this.cardMaintainBean);
			if (this.unLockCardList.size() > 0) {
				this.cardMaintainBean = this.unLockCardList.get(0);
				log.info("Successfully find card unLockCard data");
			} else {
				log.info("Can not find coresponding unLockCard data from database based on the input criteria.");
				this.cardMaintainBean = null;
			}
			flag = true;
		} catch (Exception e) {
			log.info("find card unLock data occured error, please references the detail log\n " + "[" + e + "]\n"
					+ ErrorLogUtil.printInfo(e));
			return ERROR;
		}
		if (flag) {
	...
	@Action(value = "unLockCard", results = {
			@Result(name = "success", location = "/view/card/card/maintain/cardMaintain.jsp"),
			@Result(name = "error", location = "/view/login.jsp") })
	public String unLockCard() {
		log.info("Starting to transfer unLockCard loss  infomation to service");
		boolean flag = false;
		try {
			this.cardMaintainService.updateUnLockCard(this.cardMaintainBean);
			flag = true;
		} catch (net.sf.json.JSONException e) {
			log.info("Convert to Json object occured error, please references the detail log\n " + "[" + e + "]\n"
					+ ErrorLogUtil.printInfo(e));
		} catch (Exception e) {
			log.info("transfer card unLockCard data to service occured error, please references the detail log\n " + "[" + e
					+ "]\n" + ErrorLogUtil.printInfo(e));
			return ERROR;
		...
		if (flag) {
			log.info("Successfully unLockCard card");
			this.cardMaintainBean = null;
			return SUCCESS;
		}
		return ERROR;
	 ...
	 * @return dashboard jsp
	 */
	@Action(value = "showChangePass", results = { @Result(name = "success", location = "/view/card/card/maintain/changePassword.jsp") })
	 ...
	 * 判断密码是否正确
	 */
	@Action(value = "judgePass", results = { @Result(name = "success", location = "/view/card/card/maintain/judgePass.jsp"),
			@Result(name = "error", location = "/view/login.jsp") })
	...
	public String changePass() {
		...
		boolean flag = false;
		try {
			this.cardMaintainService.updateChangePass(this.cardMaintainBean);
			flag = true;
		} catch (net.sf.json.JSONException e) {
			log.info("Convert to Json object occured error, please references the detail log\n " + "[" + e + "]\n"
					+ ErrorLogUtil.printInfo(e));
	...
	@Action(value = "showReplaceCard", results = {
			@Result(name = "success", location = "/view/card/card/maintain/replaceCard.jsp"),
			@Result(name = "error", location = "/view/login.jsp") })
	...
	public String replaceCard() {
		...
		boolean flag = false;
		try {
			this.cardMaintainService.updateReplaceCard(this.cardMaintainBean);
			flag = true;
		} catch (net.sf.json.JSONException e) {
			log.info("Convert to Json object occured error, please references the detail log\n " + "[" + e + "]\n"
					+ ErrorLogUtil.printInfo(e));
