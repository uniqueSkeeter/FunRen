...
public class EmployeeServiceImpl extends AbstractBaseService<EmployeeEntity> implements EmployeeService {
	...
	public void addEmployee(EmployeeBean employeeBean) {
		...
		final EmployeeEntity employeeEntity = this.convertDataToEntity(employeeBean);
	...
	public void deleteEmployee(Integer employeeId) {
		final EmployeeEntity deleteEntity = new EmployeeEntity();
	...
	public List<EmployeeBean> getEmplByFormCondition(EmployeeBean employeeBean) throws Exception {
		...
		final List<EmployeeBean> emplList = this.employeeDaoImpl.getAllEmployees(employeeBean);
		return emplList;
	}
